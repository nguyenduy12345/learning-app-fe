...
const Misson = () => {
  ...
  return (
    <MainLayout>
      <div className="absolute mx-auto mt-[6rem] flex w-[95%] flex-col gap-[1.5rem] bg-white font-noto md:left-[5.5rem] md:w-[51vw] lg:left-[17rem] lg:w-[42vw] lg:flex-grow lg:flex-row xl:w-[50vw] 2xl:w-[52vw]">
            ...
            <ul className="mt-4 flex flex-col gap-4">
              {missons.length !== 0 &&
                missons.map((misson, index) => (
                  <li
                    key={index}
                    className="flex h-[7rem] w-full rounded-xl border-[1px] border-[#e5e5e5] p-4"
                  >
                    <ul className="flex-grow items-start">
                      <li className="pl-2 tracking-wider">{misson.missonId.misson}</li>
                    ...
                    <div className="relative ml-4 flex items-center justify-center">
                      ...
                      />
                    {misson.completed &&  
                      <p className="absolute right-[-1px] top-[1.2rem] bg-green-500 w-[2.5rem] h-[2.5rem] flex items-center justify-center rounded-full">
                        <i className="fa-solid fa-check text-3xl font-bold text-white"></i>
                      </p>}
                    </div>
                  </li>
                ))}
